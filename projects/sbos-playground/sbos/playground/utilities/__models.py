...
from sbos.minimal.schemas import Relationships

from sbos.playground.schemas import DomainUserApp
...
class AppResponse(BaseModel):
    ...
    permission_templates: PermissionTemplates = Field(
        ..., description=perm_templates_desc
    )
    callback_url: str = Field(...)
    app_lifetime: int = Field(
        ..., description="The app's lifetime in timestamp seconds"
    )
    token_lifetime: int = Field(
        ..., description="Individual token's lifetime for this app in seconds"
    )
