...
from sbos.minimal.config.errors import register_error_handlers
from sbos.minimal.config.events import (
...
from sbos.minimal.securities.auth import default_auth_logic
from sbos.minimal.utilities.dependencies import update_dependency_supplier
...
def initialize_backend_application() -> fastapi.FastAPI:
    ...
    from sbos.minimal.services import router as api_endpoint_router
